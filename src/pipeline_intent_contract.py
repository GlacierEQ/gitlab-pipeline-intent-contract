"""Pipeline Intent Contract — SCAFFOLD STUB.

Company lens: GitLab (independent; no affiliation).
Bottleneck: CI pipelines expand permissions without a frozen intent contract for what the pipeline may touch.
...
class PipelineIntentContract:
    ...
    - `evaluate(req)` returns a PipelineIntentContractReceipt
