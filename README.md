...
Independent GlacierEQ portfolio exhibit aligned to **GitLab** operating themes.

> **Not affiliated.** This repository is not affiliated with, endorsed by, employed by, or deployed at GitLab.
...
**Pipeline Intent Contract** — Compile a pipeline intent contract (paths, secrets, environments) and fail closed on drift.
...
Lead with a small, inspectable Pipeline Intent Contract exhibit and explicit non-affiliation boundary.
...
| Surface | Path |
|---------|------|
| Mechanism stub | `src/pipeline_intent_contract.py` |
...
- No GitLab employment, endorsement, proprietary data, or production use
